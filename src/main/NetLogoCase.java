...
public class NetLogoCase extends Case implements ExtensionObject {
	...
	public LogoList asLogoList() {
		...
		list = list.lput(getState().asLogoList());
		list = list.lput(getActivity());
		list = list.lput(getOutcome().asLogoList());
	 ...
	 */
	@Override
	public NetLogoFeatureValueSet getState() {
		return (NetLogoFeatureValueSet)super.getState();
	}
	 ...
	 */
	@Override
	public NetLogoFeatureValueSet getOutcome() {
		return (NetLogoFeatureValueSet)super.getOutcome();
	}
