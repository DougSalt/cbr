...
undirected-link-breed [ some-links a-link ]
directed-link-breed [ some-directed-links a-directed-link ]

breed [first-source-set first-source]
breed [second-source-set second-source]
